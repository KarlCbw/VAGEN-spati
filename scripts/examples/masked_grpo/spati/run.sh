...
### cd /scratch/bc4211/projects/VAGEN/scripts/examples/masked_grpo/mvqa
...
# /scratch/bc4211/projects/spati/qa/360_ct.jsonl
python -m vagen.env.create_dataset --force_gen \
