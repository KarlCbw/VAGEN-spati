...
try:
    from vagen.env.spati import SpatiEnv, SpatiEnvConfig, SpatiService, SpatiServiceConfig
    REGISTERED_ENV["spati"] = {
        "env_cls": SpatiEnv,
        "config_cls": SpatiEnvConfig,
        "service_cls": SpatiService,
        "service_config_cls": SpatiServiceConfig
    }
except ImportError:
    pass